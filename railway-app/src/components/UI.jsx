...
// ─── Input ────────────────────────────────────────────────────────────────────
export function Input({ label, name, value, onChange, type = 'text', placeholder, required, error, icon, style, disabled = false, readOnly = false }) {
  return (
    <div style={{ ...style }}>
      {label && (
        <label style={{
      ...
      <div style={{ position: 'relative' }}>
        ...
        <input
          ...
          style={{
            ...
            background: disabled ? 'rgba(148, 163, 184, 0.08)' : 'var(--bg-inset)',
          ...
          onFocus={(e) => { if (!disabled) e.target.style.borderColor = 'var(--accent-blue)'; }}
