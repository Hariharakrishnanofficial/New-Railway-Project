...
from services.employee_service import DEFAULT_EMPLOYEE_PERMISSIONS
...
def require_permission(module: str, action: str) -> Callable[[Callable[..., Any]], Callable[..., Any]]:
    ...
    def decorator(f: Callable[..., Any]) -> Callable[..., Any]:
        ...
        def permission_checked(*args: Any, **kwargs: Any) -> Any:
            ...
            # Role-only RBAC: evaluate against fixed role maps.
            role = (get_current_user_role() or "").strip().lower()
            if role == "admin":
                return f(*args, **kwargs)

            allowed_actions = (DEFAULT_EMPLOYEE_PERMISSIONS.get("modules") or {}).get(module, [])
