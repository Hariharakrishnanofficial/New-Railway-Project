/**
 * CloudScaleExplorerPage.jsx — System & API Investigation Tool
 * A dedicated dashboard for testing CloudScale MCP functionalities in isolation.
...
export default function CloudScaleExplorerPage() {
            ...
            {loading ? <Spinner /> : (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                {[
                  ...
                  { label: 'CloudScale DB', val: health?.cloudscale?.initialized, status: health?.cloudscale?.initialized ? 'confirmed' : 'pending' },
            ...
            <Card title="AI Assistant (Natural Search to Criteria)">
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                <div style={{ fontSize: '13px', color: 'var(--text-muted)' }}>
                  Ask the assistant to build a CloudScale search filter for you.
                </div>
          ...
          {activeTab === 'explorer' && (
            <Card title="Advanced Data Explorer">
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 20 }}>
                ...
                <div>
                  <label style={{ fontSize: '11px', color: 'var(--text-faint)', display: 'block', marginBottom: 5, fontWeight: 700, textTransform: 'uppercase' }}>CloudScale Criteria (Optional)</label>
                  <input 
                    type="text" 
