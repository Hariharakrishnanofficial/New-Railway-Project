 ...
 * executes them against CloudScale, and displays real database records.
 */
...
═══════════════════════════════════════════════════ */
const SYSTEM_PROMPT = `You are an MCP-based database query assistant for a Railway Ticketing System on CloudScale.
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginTop: 8, fontSize: 11, color: "var(--text-muted)" }}>
          MCP Query Assistant \u00B7 CloudScale \u00B7 Enter to send \u00B7 Shift+Enter for new line
        </div>
      </div>
