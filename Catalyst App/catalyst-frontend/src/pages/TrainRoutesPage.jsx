  ...
  return (
    <div style={{ background:'rgba(59,130,246,0.04)', border:`1px solid rgba(59,130,246,0.18)`,
      ...
      {/* NOTE: Halt_Minutes & Distance_KM will appear blank when editing a stop
          loaded from CloudScale-compatible list responses. List-view returns these fields only as a
      ...
      {isEdit && (
        <div style={{ fontSize:10, color:C.muted, padding:'6px 10px', borderRadius:6,
          ...
          list-view responses may not include these details. Leave blank to keep
