...
def get_bookings():
    ...
    result = zoho.get_all_records(TABLES['bookings'], criteria=criteria, limit=limit)
...
def get_booking(booking_id):
    result = zoho.get_record_by_id(TABLES['bookings'], booking_id)
    return jsonify(result), result.get('status_code', 200)
...
def get_booking_by_pnr(pnr):
    result = zoho.get_all_records(TABLES['bookings'],
...
def update_booking(booking_id):
    ...
    result = zoho.update_record(TABLES['bookings'], booking_id, data)
    return jsonify(result), result.get('status_code', 200)
...
def delete_booking(booking_id):
    ...
    result = zoho.delete_record(TABLES['bookings'], booking_id)
    return jsonify(result), result.get('status_code', 200)
...
def confirm_booking(booking_id):
    ...
    result = zoho.update_record(TABLES['bookings'], booking_id,
...
def get_ticket(booking_id):
    bk     = zoho.get_record_by_id(TABLES['bookings'], booking_id)
