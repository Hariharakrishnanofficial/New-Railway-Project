...
def register_blueprints(app):
    ...
    from routes.users       import users_bp;       app.register_blueprint(users_bp)  # Keep for now (other routes depend on it)
    # from routes.users_cloudscale import users_cloudscale_bp; app.register_blueprint(users_cloudscale_bp)  # NEW CloudScale version - disabled for now
    ...
    from routes.email_automation import email_automation_bp; app.register_blueprint(email_automation_bp)
